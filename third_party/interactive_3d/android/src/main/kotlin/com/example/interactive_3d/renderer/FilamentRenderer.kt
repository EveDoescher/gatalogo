...
class FilamentRenderer(
    ...
    private fun initializeEngine() {
        // A Flutter Texture surface is not a safe Vulkan target on every
        // Android vendor implementation. In particular, this Redmi's driver
        // aborts inside Filament when a Vulkan swap chain is created for it.
        // Keep Filament on its supported OpenGL path; Flutter may continue to
        // use Impeller/Vulkan for the rest of the interface independently.
